...
public class RequestInterceptor {
	...
	public TransactionsResponse getPartnerTransactions(final ProceedingJoinPoint joinPoint, final String partnerCode) {
		...
		LOGGER.info(
				"[{}] IN Get Partner Transactions Response :: Partner Code : {}, Response Code : {}, Narrative : {}",
	...
	public AirtimeBalanceResponse enquireAirtimeBalance(final ProceedingJoinPoint joinPoint, final String partnerCode,
			final String msisdn) {
		...
		LOGGER.info(
				"[{}] IN Enquire Airtime Balance Response :: Partner Code : {}, Mobile Number : {}, Response Code : {}, Narrative : {}",
	...
	public AirtimeTopupResponse creditAirtime(final ProceedingJoinPoint joinPoint,
			final AirtimeTopupRequest airtimeTopupRequest) {
		...
		LOGGER.info(
				"[{}] IN Airtime Credit Response :: Partner Code : {}, Mobile Number : {}, Response Code : {}, Narrative : {}",
				ResponseMarker.getMarker(airtimeTopupResponse.getResponseCode()), airtimeTopupRequest.getPartnerCode(),
				airtimeTopupRequest.getPartnerCode(), airtimeTopupResponse.getResponseCode(),
				airtimeTopupResponse.getNarrative());
		return airtimeTopupResponse;
	}
	...
	private static AirtimeTopupResponse checkingMissingFields(final AirtimeTopupRequest airtimeTopupRequest) {
		...
		UtilityBuilder.buildErrorMessage(builder, StringUtils.isEmpty(airtimeTopupRequest.getReferenceNumber()),
