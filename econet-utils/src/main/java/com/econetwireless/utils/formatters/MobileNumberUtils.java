...
public class MobileNumberUtils {
	...
	private static String trimMobile(String mobileNumber) {
		...
		throw new InvalidMobileNumberException(ResponseCode.INVALID_REQUEST,
				"Invalid Mobile Number Supplied " + mobileNumber);
	...
	public static boolean isInitiatorSameAsBeneficiary(String initiatorMobileNumber, String beneficiaryMobileNumber) {
		try {
			return formatMobileNumber(initiatorMobileNumber)
					.equalsIgnoreCase(formatMobileNumber(beneficiaryMobileNumber));
